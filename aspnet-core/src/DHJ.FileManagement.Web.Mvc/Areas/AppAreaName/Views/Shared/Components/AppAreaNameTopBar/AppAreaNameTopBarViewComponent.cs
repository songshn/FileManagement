...
namespace DHJ.FileManagement.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTopBar
{
    public class AppAreaNameTopBarViewComponent : FileManagementViewComponent
    {
