...
using DHJ.FileManagement.Configuration.Tenants;
using DHJ.FileManagement.Timing;
using DHJ.FileManagement.Timing.Dto;
using DHJ.FileManagement.Web.Areas.AppAreaName.Models.Settings;
...
namespace DHJ.FileManagement.Web.Areas.AppAreaName.Controllers
{
    ...
    public class SettingsController : FileManagementControllerBase
    {
