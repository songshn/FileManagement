...
using DHJ.FileManagement.Authentication.TwoFactor.Google;
using DHJ.FileManagement.Authorization;
using DHJ.FileManagement.Authorization.Accounts;
using DHJ.FileManagement.Authorization.Accounts.Dto;
using DHJ.FileManagement.Authorization.Impersonation;
...
using DHJ.FileManagement.Web.Models.Account;
using DHJ.FileManagement.Security;
using DHJ.FileManagement.Security.Recaptcha;
using DHJ.FileManagement.Sessions;
using DHJ.FileManagement.Url;
using DHJ.FileManagement.Web.IdentityServer;
using DHJ.FileManagement.Web.Security.Recaptcha;
using DHJ.FileManagement.Web.Session;
using DHJ.FileManagement.Web.Views.Shared.Components.TenantChange;

namespace DHJ.FileManagement.Web.Controllers
{
    public class AccountController : FileManagementControllerBase
    {
