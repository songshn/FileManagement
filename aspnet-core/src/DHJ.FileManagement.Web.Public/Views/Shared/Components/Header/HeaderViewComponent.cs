...
using DHJ.FileManagement.Web.Public.Startup;
using DHJ.FileManagement.Web.Session;

namespace DHJ.FileManagement.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : FileManagementViewComponent
    {
