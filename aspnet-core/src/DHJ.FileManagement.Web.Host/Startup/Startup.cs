...
using DHJ.FileManagement.Install;
...
using DHJ.FileManagement.Web.Swagger;
...
namespace DHJ.FileManagement.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "FileManagement API", Version = "v1" });
            ...
            return services.AddAbp<FileManagementWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "FileManagement API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("DHJ.FileManagement.Web.wwwroot.swagger.ui.index.html");
