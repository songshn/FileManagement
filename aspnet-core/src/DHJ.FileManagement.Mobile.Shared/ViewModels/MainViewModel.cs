...
using DHJ.FileManagement.Authorization.Users.Profile.Dto;
using DHJ.FileManagement.Commands;
using DHJ.FileManagement.Core.Threading;
using DHJ.FileManagement.Models.NavigationMenu;
using DHJ.FileManagement.Services.Navigation;
using DHJ.FileManagement.ViewModels.Base;
using Plugin.Media;
...
using DHJ.FileManagement.ApiClient;
using DHJ.FileManagement.Controls;
using DHJ.FileManagement.Dto;
using DHJ.FileManagement.Extensions;
using DHJ.FileManagement.Localization;
using DHJ.FileManagement.UI;
using DHJ.FileManagement.UI.Assets;
using DHJ.FileManagement.Views;
using DependencyResolver = DHJ.FileManagement.Core.Dependency.DependencyResolver;

namespace DHJ.FileManagement.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "FileManagement";
