...
namespace DHJ.FileManagement.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FileManagementServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("DHJ.FileManagement", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
