...
using DHJ.FileManagement.MultiTenancy.Demo;
...
namespace DHJ.FileManagement.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(FileManagementConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
