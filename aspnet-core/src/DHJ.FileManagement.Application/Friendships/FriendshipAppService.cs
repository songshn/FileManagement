...
using DHJ.FileManagement.Friendships.Dto;

namespace DHJ.FileManagement.Friendships
{
    [AbpAuthorize]
    public class FriendshipAppService : FileManagementAppServiceBase, IFriendshipAppService
    {
