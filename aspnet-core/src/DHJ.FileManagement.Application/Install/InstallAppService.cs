...
using DHJ.FileManagement.Migrations.Seed.Host;
...
namespace DHJ.FileManagement.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : FileManagementAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<FileManagementDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(FileManagementConsts.ConnectionStringName).Value.ToString();
        }
