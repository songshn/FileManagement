...
using DHJ.FileManagement.Authorization.Permissions;
...
using DHJ.FileManagement.Authorization.Users.Exporting;
...
namespace DHJ.FileManagement.Authorization.Users
{
    ...
    public class UserAppService : FileManagementAppServiceBase, IUserAppService
    {
