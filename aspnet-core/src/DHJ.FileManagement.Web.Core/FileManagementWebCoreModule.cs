...
using DHJ.FileManagement.Web.Authentication.JwtBearer;
using DHJ.FileManagement.Web.Authentication.TwoFactor;
using DHJ.FileManagement.Web.Chat.SignalR;
using DHJ.FileManagement.Web.Configuration;

namespace DHJ.FileManagement.Web
{
    [DependsOn(
    ...
    public class FileManagementWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FileManagementWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(FileManagementApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FileManagementWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(FileManagementWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
