...
namespace DHJ.FileManagement.Web.Authentication.JwtBearer
{
    public class FileManagementJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public FileManagementJwtSecurityTokenHandler()
        {
